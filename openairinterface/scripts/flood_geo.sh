#!/bin/bash
#
# This script starts a single UE softmodem, which sends registration requests with incrementally generated IMSIs (not registered in the network) via a GEO satellite.
