...
#
# The script should be used with the gNB-split option, due to the required radio parameters (as hardcoded below).
...
bin/nr-uesoftmodem --rfsim --rfsimulator.serveraddr 192.168.80.129 -C 3450720000 -r 106 --numerology 1 --band 78 --ssb 516 -E --ue-fo-compensation \
